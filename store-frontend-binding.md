...
> للجداول في [`store-schema-performance-blueprint.md`](./store-schema-performance-blueprint.md): **كلها متوفرة** في الهجرة `1783373644646-store-ecommerce` + جداول Inventory/Partners الموجودة مسبقاً.  
> هذا الملف عقد الربط للفرونت: **الرابط · Auth · Query/Body · شكل `data`**.
...
`id`, `companyId`, `brandId`, `categoryId`, `sku`, `slug`, `barcode`, `nameAr`, `nameEn`, `description`, `shortDescription`, `status`, `stockStatus`, `productType`, `tracking`, `invoicePolicy`, `priceAmount`, `priceCurrency`, `costPriceAmount`, `costPriceCurrency`, `compareAtPriceAmount`, `compareAtPriceCurrency`, `trackInventory`, `quantityCache`, `lowStockThreshold`, `allowBackorder`, أبعاد، أعلام عروض (`isNewProductActive`, `isTodayDealActive`, …)، `tags`, SEO، `primaryImageUrl`, `primaryImageAlt`, `createdAt`, `updatedAt`, …
