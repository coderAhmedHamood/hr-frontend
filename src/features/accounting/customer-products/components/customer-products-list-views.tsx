...
import type { CustomerProductsDirectoryModel } from '@/features/accounting/customer-products/hooks/useCustomerProductsDirectoryModel';
import { formatNumber } from '@/shared/utils';

export function CustomerProductsListViews({ model }: { model: CustomerProductsDirectoryModel }) {
  ...
  return (
    <AccountingDirectoryViews
      ...
      columns={columns}
      getId={(item) => item.id}
      onOpen={(item) => router.push(accountingRoutes.customerProductDetail(item.id))}
      onDelete={deleteProduct}
      emptyIcon={Package}
      emptyTitle={t.common.noResults}
      deleteTitle={t.products.deleteTitle}
      deleteDescription={t.products.deleteDescription}
