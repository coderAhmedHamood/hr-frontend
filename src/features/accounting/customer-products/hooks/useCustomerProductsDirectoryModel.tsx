...
export function useCustomerProductsDirectoryModel() {
  ...
  const router = useAccountingDirectoryChrome({
    ...
    createRoute: accountingRoutes.customerProductNew,
    search,
...
export type CustomerProductsDirectoryModel = ReturnType<typeof useCustomerProductsDirectoryModel>;
