...
export function VendorPaymentsListPage() {
  ...
  return (
    <div className="flex flex-col gap-4" dir="rtl">
      <SetPageTitle
        titleAr="الدفعات"
        descriptionAr="إدارة مدفوعات وسندات الصرف للموردين"
        iconName="CreditCard"
      />
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg bg-background p-2 border border-border/40 shadow-xs">
        ...
        <div className="flex items-center gap-2 order-1 md:order-2">
          <Button
            ...
            onClick={() => router.push('/accounting/vendors/payments/new')}
          >
            جديد
          </Button>
          <div className="flex items-center gap-1.5 me-1">
            <span className="text-lg font-bold text-foreground">الدفعات</span>
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={9} className="px-4 py-16 text-center text-muted-foreground">
                  ...
                  لا توجد مدفوعات للموردين مطابقة.
                </td>
              </tr>
            )}
          </tbody>
