export type { PagePermissionDefs, PagePermissions } from '@/features/auth/permissions/types';
export { usePagePermissions } from '@/features/auth/permissions/use-page-permissions';
