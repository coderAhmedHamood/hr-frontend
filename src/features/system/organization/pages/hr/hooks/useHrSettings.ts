...
import { hrSettingsApi } from '@/features/system/organization/pages/hr/lib/api/hr-settings';
import type { UpdateHrCompanySettingsDto } from '@/features/system/organization/pages/_shared/types/settings';
