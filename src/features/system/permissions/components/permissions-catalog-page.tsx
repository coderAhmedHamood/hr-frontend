...
import { usePermissionsCatalog } from '@/features/system/permissions/hooks/usePermissionsCatalog';
import { PermissionsCatalogModuleCard } from '@/features/system/permissions/components/permissions-catalog-module-card';
import { SYSTEM_PERMISSIONS_ROLES } from '@/features/system/permissions/constants/routes';
import {
  buildPermissionTree,
  filterPermissionTree,
} from '@/features/system/permissions/utils/permission-tree';
  ...
  usePageHeaderActions(
    () => (
      <Button
        ...
        asChild
      >
        <Link href={SYSTEM_PERMISSIONS_ROLES}>
