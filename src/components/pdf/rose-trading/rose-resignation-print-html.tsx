    ...
    return (
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ fontSize: 22.5, lineHeight: 1.9, textAlign: 'right', marginBottom: 12, ...font }}>
            إلى السيد مدير/{' '}
            <span style={{ fontWeight: 700 }}>{company}</span>
          </div>
          <div style={{ fontSize: 22.5, textAlign: 'center', marginBottom: 48, ...font }}>
            بعد التحية ،،،
          </div>
          ...
          >
            <div style={{ fontSize: 22.5, fontWeight: 700, textAlign: 'right', marginBottom: 10, ...font }}>
          ...
          <p style={{ fontSize: 22.5, lineHeight: 2, textAlign: 'right', margin: '0 0 16px', ...font }}>
          ...
          <p style={{ fontSize: 22.5, lineHeight: 2, textAlign: 'right', margin: '0 0 72px', ...font }}>
            الموافق :{' '}
            {blank ? (
              <>&nbsp;&nbsp;/&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;م</>
            ) : (
